...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await emailjs.send(
        ...
        {
          from_name: form.name,
          to_name: "Ikbar Ibrahim",
          from_email: form.email,
          to_email: "ikbaribrahim4627@gmail",
  ...
  return (
    <section className="c-space my-20 pb-32" id="contact">
      <div className="relative min-h-screen flex items-center justify-center flex-col">
        ...
        <div className="contact-container pt-10">
          ...
          <p className="text-lg text-white-600 mt-3">Whether you're looking to build a new website, improve your existing platform, or need team to make a game, I'm here to help</p>
